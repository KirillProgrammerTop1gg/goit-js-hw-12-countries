...
const { alert, notice, info, success, error } = require("1ae6119df2e6d6e2");
const _ = require("b55609b9980fd4b");
...
document.querySelector(".country__input").addEventListener("input", _.debounce(()=>{
    ...
    document.querySelector(".country__input").value !== "" && fetchCountries(document.querySelector(".country__input").value).then((countries)=>{
        if (countries) {
            ...
            if (countries.length === 1) document.querySelector(".info").innerHTML = `
                ...
                `;
            else if (countries.length >= 2 && countries.length <= 10) countries.forEach((country)=>document.querySelector(".countries").innerHTML += `
...
},{"b55609b9980fd4b":"3qBDj","1ae6119df2e6d6e2":"9RSjy"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{}],"9RSjy":[function(require,module,exports) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequirec490")
